...
$(call add-clean-step, find $(OUT_DIR) -name "lights.*so" -print0 | xargs -0 rm -f)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/geeb/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/geeb/obj/EXECUTABLES/charger_touch_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/symbols/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/obj/NOTICE_FILES/src/system/bin/charger_touch.txt)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geeb/system/build.prop)
